    ...
    <div class="package-section">
      <div>
        ...
        <ul class="package-features">
          <li><span class="feature-icon">✓</span> 20 Links Everyday</li>
          <li><span class="feature-icon">✓</span> Chat Support</li>
          <li><span class="feature-icon">✓</span> Weekly Meeting For Team</li>
          <li><span class="feature-icon">✓</span> Mobile App</li>
          <li><span class="feature-icon">✓</span> Team Management</li>
          <li><span class="feature-icon disabled">○</span> Sales Of Product</li>
          <li><span class="feature-icon disabled">○</span> List Of Tags</li>
        </ul>
        <a href="#" class="modify-plan">Modify Plan</a>
      </div>
      <div class="auto-renewal">
        <div class="auto-renewal-header">
          <span style="font-weight: 600;">Monthly Auto-Renewal</span>
          <div class="toggle-switch" id="auto-renewal-toggle"></div>
        </div>
        <p class="auto-renewal-text">
          Our system will notify you every month before your subscription is due to renew, and you can turn off the
          subscription at any time if you wish.
        </p>
        <span class="auto-renewal-status" id="auto-renewal-status">Auto-Renewal: Off</span>
        <div class="mt-3">
    ...
    <div class="payment-section">
      <div class="payment-header">
        ...
        <p class="payment-subtitle">
          If you would like to finalize your subscription, please complete the payment process using a valid credit
          card.
        </p>
      </div>
      <form id="payment-form" action="process_payment.php" method="POST">
        ...
        <div class="form-row" id="card-details-row">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="expiry-date" name="expiry_date" placeholder="12/05/23" required
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="cvv" name="cvv" placeholder="012" required
        ...
        <div class="discount-section">
          ...
          <div class="discount-input-group">
            <input type="text" class="form-control discount-input" id="discount-code" name="discount_code"
              placeholder="NEW 5$ (10% Discount)" aria-describedby="discountCodePlaceholder">
